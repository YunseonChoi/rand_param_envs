...
class HumanoidRandParamsEnv(RandomEnv, utils.EzPickle):
...
if __name__ == "__main__":
    ...
    env = HumanoidRandParamsEnv()
    env.rand_params = ["body_mass"]
    print(f"Init body mass : {env.init_params['body_mass']}")
